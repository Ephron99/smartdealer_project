...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h4 class="card-title"><?php echo isset($id) ? "Purchase Order Details - ".$po_code : 'Create New Project' ?></h4>
    </div>
    <div class="card-body">
        <legend class="text-info">Project Form</legend>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="supplier_id" class="control-label text-info">Service</label>
                ...
                <fieldset>
                    ...
                    <div class="row justify-content-center align-items-end">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="item_id" class="control-label">Project Name</label>
...
// Insert data into the project_list table upon form submission
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO project_list (Project_name, service, remarks) VALUES ('$item_id', '$unit', '$qty', '$remarks')";
    // Example: mysqli_query($conn, $sql); // $conn is your database connection

    // After insertion, you might redirect the user or display a success message
}
?>
<script>
