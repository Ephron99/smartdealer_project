...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h4 class="card-title"><?php echo isset($id) ? "Purchase Order Details - ".$po_code : 'Create New Pubulication' ?></h4>
    </div>
    <div class="card-body">
        <form action="add pub.php" method="POST" enctype="multipart/form-data">
            
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6">
                        <label class="control-label text-info">Publication Title</label>
                        <input type="text" class="form-control form-control-sm rounded-0" value="" name="title">
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="supplier_id" class="control-label text-info">Image</label>
                            <input type="file" name="file_document" class="form-control form-control-sm rounded-0" value="">
                        </div>
                    </div>
                </div>
                <hr>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="remarks" class="text-info control-label">Pubulication</label>
                            <!-- <textarea name="desc" rows="5" class="form-control rounded-0"></textarea> -->
