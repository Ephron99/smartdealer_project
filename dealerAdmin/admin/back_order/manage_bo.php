...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h4 class="card-title"><?php echo isset($id) ? "Purchase Order Details - ".$po_code : 'Create New Meeting' ?></h4>
    </div>
    <div class="card-body">
        <form action="add met.php" method="POST">
            
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6">
                        <label class="control-label text-info">Meeting Title</label>
                        <input type="text" class="form-control form-control-sm rounded-0" value="" name="title">
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="supplier_id" class="control-label text-info">Meeting Date</label>
                            <input type="date" name="created_date" class="form-control form-control-sm rounded-0" value="">
                        </div>
                    </div>
                </div>
                <hr>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <!-- <textarea name="decisions" rows="5" class="form-control rounded-0"></textarea> -->
                            <textarea class="form-control" id="summary-ckeditor" name="decisions"></textarea>
                        </div>
                    </div>
                </div>
            </div>
