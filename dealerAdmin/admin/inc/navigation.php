...
<!-- Main Sidebar Container -->
      <aside class="main-sidebar sidebar-dark-primary elevation-4 sidebar-no-expand">
        ...
        <span class="brand-text font-weight-light">Smart Dealer Ltd</span>
        </a>
        <!-- Sidebar -->
              ...
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                ...
                <nav class="mt-4">
                   <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                      <a href="<?php echo base_url ?>admin/?page=garelly" class="nav-link nav-garelly">
                   ...
                   <!-- <li class="nav-item">
                    ...
                    <!--<?php echo base_url ?>admin/?page=receiving-->
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                      <a href="<?php echo base_url ?>admin/?page=team" class="nav-link nav-team">
                    ...
                    <!--<?php echo base_url ?>admin/?page=stocks-->
                    <li class="nav-item">
