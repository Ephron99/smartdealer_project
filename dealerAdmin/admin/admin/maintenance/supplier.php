...
if (isset($_POST['create_service'])) {
    ...
    $conn->query("INSERT INTO services (name, description, image) VALUES ('$name', '$desc', '$img_name')");
     
     echo "<h2>Survice Submitted Successfully!</h2>";
    echo '<p><a href="' . base_url . 'admin/?page=maintenance/supplier">Go back</a></p>';
...
if (isset($_POST['delete_service'])) {
    ...
    $conn->query("DELETE FROM services WHERE id = $id");
     header("Location: " . base_url . "admin/?page=maintenance/supplier");
...
if (isset($_POST['update_service'])) {
    ...
    if (!empty($_FILES['edit_image']['name'])) {
        ...
        $conn->query("UPDATE services SET name='$name', description='$desc' WHERE id=$id");
    }

     header("Location: " . base_url . "admin/?page=maintenance/supplier");
      echo "<h2>Service Updated Successfully!</h2>";
    echo '<p><a href="' . base_url . 'admin/?page=maintenance/supplier">Go back</a></p>';
    exit;
}
?>
	...
	<div class="card-body">
		<table class="table table-bordered table-striped">
			...
			<tbody>
				<?php 
				$i = 1;
				$qry = $conn->query("SELECT * from `services` order by `name` asc");
